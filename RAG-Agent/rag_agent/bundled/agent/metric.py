...
from rag_agent.bundled.utils.input import load_parquet
from rag_agent.bundled.utils.time import daterange
...
class MetricAgent:
    def __init__(self, root_path: str):
        ...
        # Added 'response' and 'request' to the list because they are essential Golden Signals
        self.apm_load_fields = ["time", "object_id", "error_ratio", "client_error_ratio", "server_error_ratio", "timeout", "rrt", "rrt_max", "response", "request"]
