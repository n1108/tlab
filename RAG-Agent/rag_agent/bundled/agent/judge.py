...
# 导入更新后的 Prompt 模板
from rag_agent.bundled.prompt.agent import HWLYYZC_SYSTEM_PROMPT, VALID_COMPONENTS
...
"""
    ...
    def analyze(self, uuid: str, description: str, metric_result: Any, trace_result: Any, log_result: Any) -> Dict:
        ...
        logger.debug("Judge user prompt chars=%s", len(user_prompt))
        ...
        try:
            ...
            logger.debug("Judge response chars=%s", len(content or ""))
